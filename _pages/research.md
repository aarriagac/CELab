...
![]({{ site.url }}{{ site.baseurl }}/images/respic/genediscovery.png){: style="width: 25%; max-width: 300px; float: left;margin-right: 30px; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/scn2aMut.png){: style="width: 25%; max-width: 300px; float: left;margin-right: 30px; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/asdcnv.png){: style="width: 25%; max-width: 300px; float: left;margin-right: 30px; border: 10px"}
